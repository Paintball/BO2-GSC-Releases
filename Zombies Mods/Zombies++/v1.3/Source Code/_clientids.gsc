...
onPlayerDowned()
{
    ...
    for(;;)
    {
        ...
        self.icon1 Destroy();
        self.icon1 = undefined; //deletes the perk icons and resets the variable
        self.icon2 Destroy();
        self.icon2 = undefined; //deletes the perk icons and resets the variable
        self.icon3 Destroy();
        self.icon3 = undefined; //deletes the perk icons and resets the variable
        self.icon4 Destroy();
        self.icon4 = undefined; //deletes the perk icons and resets the variable
    }
}
...
init_custom_powerups() //credit goes to _Ox for most code
{
    ...
    {
        include_zombie_powerup("fast_feet");
        add_zombie_powerup("fast_feet", "t6_wpn_zmb_perk_bottle_doubletap_world", &"ZOMBIE_POWERUP_FAST_FEET", ::func_should_always_drop, 0, 0, 0);
        powerup_set_can_pick_up_in_last_stand("fast_feet", 1);
...
custom_powerup_grab(powerup, player) //credit to _Ox much thx for powerup functions
{
    if(powerup.powerup_name == "money_drop")
        ...
        level thread [[level.original_zombiemode_powerup_grab]](powerup, player);
}
